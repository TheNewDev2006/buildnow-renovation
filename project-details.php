        ...
        <div id="smooth-wrapper">
            <div id="smooth-content">
                ...
                <section class="project-details-section section-padding fix">
                    <div class="container">
                        <div class="project-details-top-image fix wow fadeInUp">
                            <img data-speed=".8" src="assets/img/inner-page/project/project-details-01.jpg" alt="img">
                        </div>
                        <div class="row g-4">
                            <div class="col-lg-8">
                                <div class="project-details-content">
                                    <h2 class="tx-title sec_title  tz-itm-title tz-itm-anim">Redefining Construction</h2>
                                    <p class="wow fadeInUp">
                                        Holisticly benchmark functional products fore excellent methods of emporment. Seamlessly visualize innovative readiness whereas extensive initiatives. Completely unleash frictionless data via end to end services. Continually unleash virtual e tailers through magnetic core compncies. Interactively engage distributed alments via focused alignments. Dynamically fabricate excellent innovation for go forward technology. Intrinsicly impact empowered scenarios after cost effective outsourcing productivate pandemic e business
                                    </p>
                                    <h3 class="wow fadeInUp" data-wow-delay=".2s">The Challenge Of Project</h3>
                                    ...
                                    <p class="wow fadeInUp" data-wow-delay=".4s">
                                        Dynamically fabricate excellent go forward technology. Intrinsicly impact empowered scenarios after cost effective outsourcing. Synenvtically productivate pandemic e-business rather than state of the art e-tailers. Completely unleash frictionless data via services.
                                    </p>
                                    <div class="image-items wow fadeInUp" data-wow-delay=".5s">
                                        <div class="row g-4">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="project-image">
                                                    <img src="assets/img/inner-page/project/project-details-02.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="project-image">
                                                    <img src="assets/img/inner-page/project/project-details-03.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slider-button d-flex align-items-center justify-content-between wow fadeInUp" data-wow-delay=".9s">
                                ...
                                <div class="project-details-sidebar">
                                    <div class="sidebar-widget">
                                        <div class="sideber-title">
                                            <h4 class="wow fadeInUp" data-wow-delay=".2s">Project Information</h4>
                                        </div>
                                        <ul class="project-infrom wow fadeInUp" data-wow-delay=".4s">
                                            <li>
                                                <div class="icon">
