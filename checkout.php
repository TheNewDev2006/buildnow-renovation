            ...
            <section class="breadcrumb-wrapper bg-cover fix" style="background-image: url(assets/img/inner-page/breadcrumb.jpg);">
                <div class="container">
                    <div class="page-heading">
                        ...
                        <h1 class="breadcrumb-title">SHOPPING CHECKOUT</h1>
                    </div>
                </div>
            </section>
                                    ...
                                    <div class="col-md-7 col-lg-8 col-xl-9">
                                        <div class="checkout-single-wrapper">
                                            ...
                                            <div class="checkout-single checkout-single-bg">
                                                ...
                                                <div class="mt-4">
                                                    <a class="theme-btn-main style-2 wow fadeInUp" data-wow-delay=".5s" href="checkout.html">
                                                        <span class="theme-btn-arrow-left"> <i class="fa-solid fa-arrow-up-right"></i> </span>
                                                        <span class="theme-btn">Payment Now</span>
                                                        <span class="theme-btn-arrow-right"> <i class="fa-solid fa-arrow-up-right"></i> </span>
                                                    </a>
                                                </div>
                                            </div>
