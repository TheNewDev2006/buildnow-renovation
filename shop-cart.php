                                    ...
                                    <tbody>
                                        <tr class="align-items-center py-3">
                                            <td>
                                                <div class="cart-item-thumb d-flex align-items-center gap-4">
                                                    <i class="fas fa-times"></i>
                                                    <img class="w-100" src="assets/img/inner-page/shop/sm-1.png" alt="product">
                                                    <span class="head text-nowrap">Professional Jigsaw</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="align-items-center py-3">
                                            <td>
                                                <div class="cart-item-thumb d-flex align-items-center gap-4">
                                                    <i class="fas fa-times"></i>
                                                    <img class="w-100" src="assets/img/inner-page/shop/sm-2.png" alt="product">
                                                    <span class="head text-nowrap">Cordless Screwdriver Drill</span>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <span class="price-usd">
                            ...
                            <div class="coupon-items d-flex flex-md-nowrap flex-wrap justify-content-between align-items-center gap-4 pt-4">
                                <form action="#" class="d-flex flex-sm-nowrap flex-wrap align-items-center gap-3">
                                    ...
                                    <button type="submit" class="theme-btn-main style-2">
                                        <span class="theme-btn-arrow-left"> <i class="fa-solid fa-arrow-up-right"></i> </span>
                                        <span class="theme-btn">APPLY COUPON</span>
                                        <span class="theme-btn-arrow-right"> <i class="fa-solid fa-arrow-up-right"></i> </span>
                                    </button>
                                </form>
                                <button type="submit" class="theme-btn-main style-2">
                                    <span class="theme-btn-arrow-left"> <i class="fa-solid fa-arrow-up-right"></i> </span>
                                    <span class="theme-btn">UPDATE CART</span>
                                    <span class="theme-btn-arrow-right"> <i class="fa-solid fa-arrow-up-right"></i> </span>
                                </button>
                            </div>
                        </div>
                ...
                <div class="cart-total-area section-padding pt-0">
                    <div class="container">
                        <div class="cart-total-items">
                            ...
                            <a class="theme-btn-main style-2" href="checkout.html">
                                <span class="theme-btn-arrow-left"> <i class="fa-solid fa-arrow-up-right"></i> </span>
                                <span class="theme-btn">Proceed to Checkout</span>
                                <span class="theme-btn-arrow-right"> <i class="fa-solid fa-arrow-up-right"></i> </span>
                            </a>
                        </div>
                    </div>
