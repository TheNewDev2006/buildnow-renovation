            ...
            <section class="breadcrumb-wrapper bg-cover fix" style="background-image: url(assets/img/inner-page/breadcrumb.jpg);">
                <div class="container">
                    <div class="page-heading">
                        ...
                        <h1 class="breadcrumb-title">SHOP DETAILS</h1>
                    </div>
                </div>
            </section>
                    ...
                    <div class="shop-details-wrapper">
                        <div class="row">
                                ...
                                <div class="tab-content">
                                    <div id="thumb1" class="tab-pane fade show active">
                                        <div class="shop-thumb">
                                            <img src="assets/img/inner-page/shop/details-1.png" alt="img">
                                        </div>
                                    </div>
                                    <div id="thumb2" class="tab-pane fade">
                                        <div class="shop-thumb">
                                            <img src="assets/img/inner-page/shop/details-2.png" alt="img">
                                        </div>
                                    </div>
                                    <div id="thumb3" class="tab-pane fade">
                                        <div class="shop-thumb">
                                            <img src="assets/img/inner-page/shop/details-3.png" alt="img">
                                        </div>
                                    </div>
                                    </div>
                                    <ul class="nav mb-5">
                                        <li class="nav-item">
                                            <a href="#thumb1" data-bs-toggle="tab" class="nav-link ps-0 active">
                                                <img src="assets/img/inner-page/shop/sm-1.png" alt="img">
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#thumb2" data-bs-toggle="tab" class="nav-link">
                                                <img src="assets/img/inner-page/shop/sm-2.png" alt="img">
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#thumb3" data-bs-toggle="tab" class="nav-link">
                                                <img src="assets/img/inner-page/shop/sm-3.png" alt="img">
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="star pb-3 wow fadeInUp">
                                ...
                                <h2 class="pb-3 hero_title tv_hero_title hero_title_1 wow fadeInUp" data-wow-delay=".2s">Air-Purifying Plant for Bedroom Corners</h2>
                                <p class="mb-3 wow fadeInUp" data-wow-delay=".4s">
                                ...
                                <div class="price-list wow fadeInUp" data-wow-delay=".6s">
                                    <ul>
                                        <li>
                                            $899.00
                                        </li>
                                ...
                                <h6 class="details-info"><span>SKU:</span> <a href="shop-details.html">124224</a></h6>
                                <h6 class="details-info"><span>Categories:</span> <a href="shop-details.html">Crux Indoor Fast and Easy</a></h6>
                                <h6 class="details-info"><span>Tags:</span> <a href="shop-details.html">accessories, business</a></h6>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="review-items">
                                    <div class="admin-items d-flex flex-wrap flex-md-nowrap align-items-center pb-4">
                                        ...
                                        <div class="content p-4">
                                            ...
                                            <h5>miklos salsa<span>27June 2026 at 5.44pm</span></h5>
                                            <div class="star">
                                    ...
                                    <div class="admin-items d-flex flex-wrap flex-md-nowrap align-items-center pb-4">
                                        ...
                                        <div class="content p-4">
                                            <div class="head-content pb-1 d-flex flex-wrap justify-content-between">
                                            <h5>Ethan Turner <span>27June 2026 at 5.44pm</span></h5>
                                            <div class="star">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                    ...
                                    <div class="admin-items d-flex flex-wrap flex-md-nowrap align-items-center pb-4">
                                        ...
                                        <div class="content p-4">
                                            <div class="head-content pb-1 d-flex flex-wrap justify-content-between">
                                            <h5>Devid Miller<span>27June 2026 at 5.44pm</span></h5>
                                            <div class="star">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                        ...
                                        <form action="#" id="contact-form" method="POST">
                                            ...
                                            <div class="col-lg-6 wow fadeInUp" data-wow-delay=".9">
                                                <button type="submit" class="theme-btn-main style-2">
                                                    <span class="theme-btn-arrow-left"> <i class="fa-solid fa-arrow-up-right"></i> </span>
                                                    <span class="theme-btn">Post Submit</span>
                                                    <span class="theme-btn-arrow-right"> <i class="fa-solid fa-arrow-up-right"></i> </span>
                                                </button>
                                            </div>
                                            </div>
