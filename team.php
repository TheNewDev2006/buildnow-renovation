                        ...
                        <div class="row g-4">
                                ...
                                <div class="team-card-item mt-0">
                                    <div class="team-image">
                                        ...
                                        <div class="social-profile">
                                            ...
                                            <span class="plus-btn"><i class="fa-solid fa-share"></i></span>
                                        </div>
                                    </div>
                                    <div class="team-content">
                                        <h5>
                                            <a href="team-details.html">Shophia Smith</a>
                                        </h5>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                                <div class="team-card-item mt-0">
                                    ...
                                    <div class="team-content">
                                        <h5>
                                            <a href="team-details.html">Enrico Brown</a>
                                        </h5>
                                        <p>Managing Director</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                                <div class="team-card-item mt-0">
                                    ...
                                    <div class="team-content">
                                        <h5>
                                            <a href="team-details.html">Adam Norman</a>
                                        </h5>
                                        <p>Managing Director</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                                <div class="team-card-item mt-0">
                                    <div class="team-image">
                                        <img src="assets/img/inner-page/team/team-04.jpg" alt="img">
                                        <div class="social-profile">
                                            <ul>
                                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a href="#"><i class="fab fa-instagram"></i></a></li>
                                    ...
                                    <div class="team-content">
                                        <h5>
                                            <a href="team-details.html">Jesica White</a>
                                        </h5>
                                        <p>Managing Director</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                                <div class="team-card-item mt-0">
                                    <div class="team-image">
                                        <img src="assets/img/inner-page/team/team-05.jpg" alt="img">
                                        <div class="social-profile">
                                            <ul>
                                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a href="#"><i class="fab fa-instagram"></i></a></li>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".9s">
                                <div class="team-card-item mt-0">
                                    <div class="team-image">
                                        <img src="assets/img/inner-page/team/team-06.jpg" alt="img">
                                        <div class="social-profile">
                                            <ul>
                                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a href="#"><i class="fab fa-instagram"></i></a></li>
