(function ($) {
    ...
    $document.ready(function () {
      ...
      ================================ */
        ...
        } catch (e) { console.error("Meanmenu init failed", e); }
...
================================ */
        ...
        try {
            ...
            console.error("Magnific Popup (Image) init failed", e);
        }
        ...
        try {
            ...
            console.error("Magnific Popup (Video) init failed", e);
        }
      ...
      ================================ */
        ...
        try {
            ...
            console.error("CounterUp init failed", e);
        }
      ...
      ================================ */
        ...
        if ($('.single-select').length) {
            try {
                ...
                console.error("NiceSelect init failed", e);
            }
        }
       ...
       ================================ */
        ...
        if ($('.tz-sub-tilte').length) {
            ...
            try {
                ...
                agtsub.each(function (index, element) {
                    ...
                    if ($(element).hasClass('tz-sub-anim')) {
                ...
                console.error("Error initializing SplitText for tz-sub-tilte:", error);
            }
        }
        ...
        if ($('.tz-itm-title').length) {
            ...
            try {
                gsap.registerPlugin(SplitText);
                txtheading.each(function (index, element) {
                    ...
                    if ($(element).hasClass('tz-itm-anim')) {
                        gsap.set(element.split.chars, {
                            opacity: .3,
                            x: "-7",
                        });
                ...
                console.error("Error initializing SplitText for tz-itm-title:", error);
            }
        }
        ...
        if (window.matchMedia("(min-width: 1200px)").matches) {
            if (document.querySelectorAll(".actually-area").length > 0) {
                try {
                    ...
                    const textLines = new SplitText(".t_line", { type: "lines" });
                    textLines.lines.forEach((target) => {
                        timeline.to(target, {
                    ...
                    timeline.to(".actually-area .section-title", {
                        scale: 40,
                        opacity: 0,
                        ease: "power4.inOut",
                        delay: 0.35,
                    ...
                    timeline.to(".actually-area", {
                        backgroundColor: "#fff",
                        duration: 0.45,
                    }, "-=0.50");
                } catch (error) {
                    console.error("Error in actually-area GSAP animation:", error);
                }
            }
        }
